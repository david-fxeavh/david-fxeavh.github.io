...
![image-center]({{ '/img/rickroll_4k.jpg' | absolute_url }}){: .align-center}

The image should be **centered** with the `.align-center` class.

![image-left]({{ '/img/sb.png' | absolute_url }}){: .align-left} The rest of this paragraph is filler for the sake of seeing the text wrap around the 150×150 image, which is **left aligned** with the `.align-left` class.
...
![no-alignment]({{ '/img/kb2.jpg' | absolute_url }})

The image above, though `1200px` wide, should not overflow the content area. It should remain contained with no visible disruption to the flow of content.

![image-right]({{ '/img/hf.png' | absolute_url }}){: .align-right}
...
<figure class="align-center">
  <a href="#"><img src="{{ '/img/rickroll_4k.jpg' | absolute_url }}" alt=""></a>
...
<figure style="width: 150px" class="align-left">
  <img src="{{ '/img/hf.png' | absolute_url }}" alt="">
...
<figure style="width: 1200px">
  <img src="{{ '/img/rickroll_4k.jpg' | absolute_url }}" alt="">
...
<figure style="width: 300px" class="align-right">
  <img src="{{ '/img/bg-tt1.jpg' | absolute_url }}" alt="">
